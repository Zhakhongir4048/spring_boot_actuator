package com.example.spring_boot_actuator.controller;

import com.example.spring_boot_actuator.entity.Employee;
import com.example.spring_boot_actuator.service.EmployeeService;
...
public class EmployeeController {
    ...
    public List<Employee> getEmployeesByName(@PathVariable("name") String name) {
        return employeeService.getEmployeesFindByName(name);
    }
